    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Gestión de Novedades
          <button
            type="button"
            @click="abrirModal('modelo','registrar')"
        ...
        <div class="card-body">
            ...
            <div class="col-md-6">
              <div class="input-group">
                ...
                <input
                  type="text"
                  v-model="buscar"
                  @keyup.enter="listarMain(1,buscar,criterio)"
                  class="form-control"
                  placeholder="Texto a buscar"
                >
                <button
                  type="submit"
                  @click="listarMain(1,buscar,criterio)"
          ...
          <table class="table table-bordered table-striped table-sm">
            ...
            <tbody>
              <tr v-for="modelo in arrayMain" :key="modelo.id">
                <td v-text="modelo.nombre"></td>
                <td v-text="modelo.desc"></td>

                <td>
                  <md-button class="md-icon-button " @click="abrirModal('modelo','actualizar',modelo)" title="Actualizar">                         
                    <i class="material-icons Color3">edit</i>
                  </md-button>
                  <md-button class="md-icon-button md-primary " @click="eliminarModelo(modelo)" title="Eliminar">
            ...
            <form action method="post" enctype="multipart/form-data" class="form-horizontal">
              <md-card-content>
                <md-field :class="getValidationClass('nombre')">
                  ...
                  >El Nombre  de la Novedad es requerido</span>
                  <!-- <span class="md-error" v-else-if="!$v.form.firstName.minlength">Invalid first name</span> -->
                </md-field>

                <md-field :class="getValidationClass('desc')">
                  <label for="desc-name">Decripción</label>
                  <md-input
                    name="desc-name"
                    id="desc-name"
                    autocomplete="given-name"
...
export default {
  ...
  methods: {
    ...
    listarMain(page, buscar, criterio) {
      let me = this;
      var url =
        "/novedad?page=" +
        page +
    ...
    cambiarPagina(page, buscar, criterio) {
      ...
      me.listarMain(page, buscar, criterio);
    },
    registrarModel() {
  ...
  mounted() {
    ...
    this.listarMain(1, this.buscar, this.criterio);
  }
};
</script>
<style>
