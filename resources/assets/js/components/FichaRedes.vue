    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Gestion de Redes
          <button
            type="button"
            ...
            <form action method="post" enctype="multipart/form-data" class="form-horizontal">
              <md-card-content>
                <div class="md-layout">
                  ...
                  <div class="md-layout-item md-size-20">
                    <md-field md-clearable>
                      <label>Diametro Tuberia</label>
                      <md-select v-model="tpDiam" md-dense>
                        <md-option
                          v-for="diam in arrayDiam"
                          :key="diam.id"
                          :value="diam.id"
                        >{{diam.nombre}}</md-option>
                      </md-select>
                    </md-field>
                  </div>&nbsp;&nbsp;&nbsp;
                ...
                <div class="md-layout">
                  ...
                  <template v-else-if="cbx==0">
                    <div class="md-layout-item">
                      <md-field md-clearable>
                        <label>Municipio Inicio</label>
                        <md-select v-model="idMp" md-dense>
                          <md-option
                            v-for="(mpio,index) in arrayMpio"
                            :key="`mpio-${index}`"
                    ...
                    <div class="md-layout-item">
                      <md-field md-clearable>
                        <label>Municipio Fin</label>
                        <md-select v-model="idMp2" md-dense>
                          <md-option
                            v-for="(mpio,index) in arrayMpio"
                            :key="`mpio-${index}`"
                            :value="mpio.id"
                  ...
                  <div class="md-layout-item">
                    ...
                    >
                      <label>Fecha Creacíon</label>
                    </md-datepicker>
                  </div>&nbsp;&nbsp;&nbsp;
                  <div class="md-layout-item md-size-15">
                    <md-field md-clearable>
                      <label>Cant. Polivalvulas</label>
                      <md-input type="number" v-model="cantP"></md-input>
                    </md-field>
                  </div>
                </div>
                <div class="md-layout">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      arrayDpto: [],
      arrayMpio: [],
      arraytpRed: ["URBANA", "RURAL", "TRONCAL"],
      arrayRed: [],
      arrayDiam: [],
